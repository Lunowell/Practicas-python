...
import cargar_imagenes as load_imagenes
...
def coll(alias):
    ...
    while True:
        ...
        if event == "amor": # Remplazarla por un collage que se deban seleccionar maximo 2 fotos
            load_imagenes.cargar_imagenes(2,alias)
        if event == "naturaleza": # Remplazarla por un collage que se deban seleccionar maximo 2 fotos
            load_imagenes.cargar_imagenes(2,alias)
        if event == "ciencia":# Remplazarla por un collage que se deban seleccionar maximo 3 fotos
            load_imagenes.cargar_imagenes(3,alias)
        if event == "generico":# Remplazarla por un collage que se deban seleccionar maximo 3 fotos
            load_imagenes.cargar_imagenes(3,alias)
        if event == "familia":# Remplazarla por un collage que se deban seleccionar maximo 4 fotos
            load_imagenes.cargar_imagenes(4,alias)
        if event == "ayd":# Remplazarla por un collage que se deban seleccionar maximo 6 fotos
            load_imagenes.cargar_imagenes(6,alias)
